          ...
          <div className="grid grid-cols-3 gap-[30px]">
            {[...Array(6)].map((_, i) => (
              <ScatteredBlock key={i} delay={0.6}>
                <div
                  className={`w-[221.14px] h-[215.29px] border border-black/60 dark:border-white/20 ${i === 1 ? 'bg-[repeating-linear-gradient(135deg,transparent,transparent_13px,currentColor_13px,currentColor_14px)] text-black/20 dark:text-white/20' : ''}`}
                />
              </ScatteredBlock>
            ))}
          </div>
          ...
          <div className="grid grid-cols-3 gap-[30px]">
            {[...Array(6)].map((_, i) => (
              <ScatteredBlock key={i} delay={0.2}>
                <div
                  className={`w-[221.14px] h-[215.29px] border border-black/60 dark:border-white/20 ${i === 4 ? 'bg-[repeating-linear-gradient(135deg,transparent,transparent_13px,currentColor_13px,currentColor_14px)] text-black/20 dark:text-white/20' : ''}`}
                />
              </ScatteredBlock>
            ))}
          </div>
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none">
        ...
        >
          <div className="space-y-6">
            ...
            >
              Build Stellar-Powered <br className="hidden sm:block" /> Apps.
              Faster.
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 30 }}
          ...
          >
            <Link href="/docs/getting-started/introduction">
              <Button className="h-12 px-8 py-3 text-lg bg-black dark:bg-white text-white dark:text-black rounded-none border-none hover:bg-black hover:opacity-90 transition-all flex items-center gap-2 font-medium">
                Get Started
              </Button>
            </Link>
