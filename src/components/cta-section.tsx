  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-white dark:bg-black flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 sm:px-8 max-w-3xl mx-auto">
        ...
        >
          Install Nextellar, run your first command, and start coding
          immediately. Everything else is already taken care of.
        </motion.p>
        ...
        >
          ...
          >
            <motion.button
              className="bg-black dark:bg-white text-white dark:text-black px-8 py-3.5  font-medium hover:opacity-90 transition-colors w-full "
          ...
          >
            <motion.button
              className="bg-white dark:bg-black text-black dark:text-white px-8 py-3.5  w-full font-medium border-2 border-gray-300  hover:bg-gray-50 hover:opacity-90 transition-colors flex items-center justify-center gap-2 w-full "
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.95 }}
              transition={{ type: 'spring', stiffness: 400, damping: 17 }}
            >
