      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-start gap-6 max-w-lg z-10">
          ...
          <p className="text-lg text-neutral-500 dark:text-neutral-400 leading-relaxed">
            Nextellar integrates seamlessly with your existing ecosystem,
            including Next.js, Node.js, Tailwind, ESLint, and Jest, configuring
          ...
          <Link
            ...
            className="mt-4 px-8 py-4 bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 font-medium rounded-lg hover:opacity-90 transition-opacity active:scale-[0.98] shadow-sm"
          >
            Try It Out
          </Link>
        </div>
