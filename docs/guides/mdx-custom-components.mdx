...
<SidebarProvider defaultOpen={true}>
  <SidebarLayout>
    <Sidebar>
      ...
      <SidebarContent>
        <SidebarMenu>
          <SidebarMenuItem icon={<Home className="h-4 w-4" />} label="Home" href="/docs" />
          <SidebarMenuItem icon={<Component className="h-4 w-4" />} label="Components" defaultOpen isCollapsable>
