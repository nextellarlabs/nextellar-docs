...
- **Component slug** — matches the MDX filename without the `.mdx` extension.
  For example `wallet-connect-button.mdx` → `wallet-connect-button`.
...
public/screenshots/wallet-connect-button/disconnected.png
public/screenshots/wallet-connect-button/connected.png
```
