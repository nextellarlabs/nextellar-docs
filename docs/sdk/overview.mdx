...
- **WalletConnectButton** - Pre-built wallet connection button with theme support
...
- [Error Class Hierarchy](/docs/sdk/error-class-hierarchy) - SDK error types and handling
- [BigNumber Usage](/docs/sdk/bignumber-usage) - Fixed-point arithmetic and conversion helpers
