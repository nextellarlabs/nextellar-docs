...
10 checks passed, 1 check failed
```
...
Validate and prepare your project for production deployment. This command checks that your Horizon and Soroban RPC endpoints are properly configured and builds an optimized production bundle of your Stellar dApp.
```bash
