...
### Custom Configuration (with custom wallet selection)
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  ...
  <a
    href="/docs/troubleshooting/common-error-messages"
    className="block p-4 border rounded-lg hover:border-primary transition-colors"
  >
...
- [Project Structure](/docs/getting-started/installation#project-structure) - Understand the generated code
````
