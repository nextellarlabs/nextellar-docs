...
[Full component documentation](/docs/components/wallet-connect-button)
...
- [WalletConnectButton](/docs/components/wallet-connect-button) - Pre-built button component
