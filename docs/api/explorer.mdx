...
<div className="grid gap-4 my-6">
  <details className="rounded-lg border p-4">
    ...
    | `WalletConnectButton` | Component | Render the default wallet connection control |
    ...
    Related docs: [WalletProvider](/docs/hooks/wallet-provider), [useStellarWallet](/docs/hooks/use-stellar-wallet), [WalletConnectButton](/docs/components/wallet-connect-button).
